  ...
  const [editFormData, setEditFormData] = useState<Partial<type.getTask>>({});
   ...
   return (
    ...
    {projects.map((projectItem) => (
      <NavLink to={`/project/${projectItem.id}`} key={projectItem.id} className="card w-full  rounded-4xl p-4 bg-white-100 shadow shadow-md duration-100 hover:shadow-lg border border-gray-300">
