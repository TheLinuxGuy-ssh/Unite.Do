...
const Tasks = () => {
  ...
  <thead className="">
    <tr>
      ...
      <th className="border-b text-left p-5 border-gray-300 ...">Member UUID</th>
      <th className="border-b text-left p-5 border-gray-300">Role</th>
      <th className="border-b text-left p-5 border-gray-300">Projects Assigned</th>
    </tr>
  </thead>
  <tbody>
    <tr>
